            ...
            <section className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between px-5 py-24">
                <div className="lg:w-1/2 w-full mb-10 lg:mb-0 text-left lg:pr-10">
                    ...
                    <div className="flex space-x-4 mt-8">
                        ...
                        <Link href="https://github.com/FatimaNazeer777/Image-Search"><button className="inline-flex items-center justify-center text-[#424242] bg-[#e3f2fd] border-0 py-3 px-6 focus:outline-none hover:bg-[#bbdefb] rounded-lg shadow-lg transition duration-300 transform hover:scale-105">
                            Source Code
                        </button>
                        </Link>
                    </div>
