      ...
      {showProfile && (
        <>
          ...
          <div className="text-center mb-6">
            <h1 className="title-font sm:text-5xl text-4xl mb-6 font-extrabold text-white leading-tight">Fatima Nazeer</h1>
            <p className="text-slate-300 mt-2">
              Welcome to my personal blog where I share my thoughts and tutorials on web development.
            </p>
          </div>
        </>
      )}
