            ...
            <section className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between px-5 py-24">
                <div className="lg:w-1/2 w-full mb-10 lg:mb-0 text-left lg:pr-10">
                    ...
                    <div className="flex space-x-4 mt-8">
                        ...
                        <Link href="https://github.com/FatimaNazeer777/Search-Github-Profiles"><button className="inline-flex items-center justify-center text-black bg-[#e1e4e8] border-0 py-3 px-8 focus:outline-none hover:bg-[#d1d5da] rounded-lg shadow-md transition duration-300">
                            Source Code
                        </button>
                        </Link>
                    </div>
